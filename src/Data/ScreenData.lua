			...
			ComponentData =
			{
				...
				Background =
				{
					...
					Children =
					{
						...
						RollChosen = mod.genBtn("RollChosen", mod.RollChosen),
						ExpiringTimeThreshold = mod.genBtn("ExpiringTimeThreshold", mod.ExpiringTimeThreshold),
						AlwaysArtemisCombat = mod.genBtn("AlwaysArtemisCombat", mod.AlwaysAllNPCCombat),
						TorchNumAdd = mod.genBtn("TorchNumAdd", mod.TorchNumAdd),
						TorchNumRestore = mod.genBtn("TorchNumRestore", mod.TorchNumRestore),
						FastMagnetism = mod.genBtn("FastMagnetism", mod.FastMagnetism),
						LobMaxAmmo = mod.genBtn("LobMaxAmmo", mod.LobMaxAmmo),
						GuaranteedZagContract = mod.genBtn("GuaranteedZagContract", mod.GuaranteedZagContract),
						--setEphyraZoomOut
						-- EphyraZoomOut = {
						-- 	Name = "ButtonDefault",
